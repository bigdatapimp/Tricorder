/*
// -- Tricorder v0.35.1 - By Tony Dillberg
...
#define BUTTON_RT_MIN 325
#define BUTTON_RT_MAX 345
...
// --- Navigation specific ---
#define COMPASS_RADIUS 10
#define CENTER_X 115
#define CENTER_Y 45
#define NEEDLE_LENGTH 7
...
void setup() {
  ...
  // --- Splash Screen ---
    ...
    display.println(" Tricorder - v0.35.1");
  ...
  Serial.println("Tricorder - v0.35.1");
...
void runAtmospheric(int pressType) {
  ...
  if (millis() - lastAtmosphericUpdate > 2000) {
    ...
    float pressure = BARO.readPressure(MILLIBAR) * 0.02994;
...
void runNavigation(int pressType) {
  ...
  if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable() && IMU.magneticFieldAvailable()) {
    ...
    // --- Draw smaller compass in bottom-right ---
