/*
// -- Tricorder v0.43.2 - By Tony Dillberg
...
// -- franchise.
// --
// -- Added GPS Speed under Navigation
// -- Chage between MHP and KPH - Long Press Up
// -- Added Chage between Altitude in Meters or Feet - Long Press Down
...
void runNavigation(int pressType) {
  ...
  if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable() && IMU.magneticFieldAvailable()) {
    ...
    tft.fillRect(23, 45, 30, 10, BLACK);  
    tft.setTextSize(1);
    tft.setTextColor(BLUE);
    tft.setCursor(0, 45);
    tft.print("Hdg:");
